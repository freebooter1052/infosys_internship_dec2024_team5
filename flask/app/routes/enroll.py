...
@enroll_blueprint.route('/enroll', methods=['POST', 'OPTIONS'])
def enroll_course():
   ...
   # if request.method == 'OPTIONS':
    ...
    try:
        ...
        if 'courseId' not in data or 'userEmail' not in data or 'userName' not in data:
        ...
        db.session.commit()
        logging.info(f"Successfully enrolled user {data['userEmail']} in course {data['courseId']}")
